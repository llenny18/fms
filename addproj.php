                    ...
                    <form method="post">
                        ...
                        <div class="form-row">
                          <div class="form-group col-md-6">
                            ...
                            <input required type="text" value="<?php echo(rand(100000009,1000000009)) ?>" readonly name="pid" class="form-control"  id="input" placeholder="0">
                          </div>
                          <div class="form-group col-md-6">
                            <label for="input">Name</label>
                            <input required name="pname" type="text" class="form-control" id="input"  placeholder="email">
                          </div>
                        </div>
                        <div class="form-group">
                          <label for="inputAddress">Description</label>
                          <input required name="pdesc" type="text" class="form-control" id="inputAddress"  placeholder="Full Name">
                        </div>

                        <div class="form-row">
                          <div class="form-group col-md-6">
                            <label for="input">Price</label>
                            <input required type="text" name="pprice" class="form-control"  id="input" placeholder="0">
                          </div>
                          <div class="form-group col-md-6">
