...
<head>
  ...
  // Example usage with a specific projectID (replace with your desired projectID)
  $projectID = $_GET['pid'];
  $selectedProjects = getProjectById($conn, $projectID);

if(isset($_POST['pupdate'])){
  $projectIDToUpdate = $_POST['pid'];  // Replace with the specific projectID you want to update
  $newProjectName =  $_POST['pname'];
  $newProjectDescription =  $_POST['pdesc'];
                      ...
                      <?php foreach ($selectedProjects as $project) { ?>
                        <div class="form-row">
                          <div class="form-group col-md-6">
                            ...
                            <input required type="text" readonly name="pid" class="form-control" value="<?= $project->projectID ?>" id="input" placeholder="0">
                          </div>
                          <div class="form-group col-md-6">
                            <label for="input">Name</label>
                            <input required name="pname" type="text" class="form-control" id="input" value="<?= $project->projectName ?>" placeholder="email">
                          </div>
                        </div>
                        <div class="form-group">
                          <label for="inputAddress">Description</label>
                          <input required name="pdesc" type="text" class="form-control" id="inputAddress" value="<?= $project->projectDescription ?>" placeholder="Full Name">
                        </div>

                        <div class="form-row">
                          <div class="form-group col-md-6">
                            <label for="input">Price</label>
                            <input required type="text" name="pprice" class="form-control" value="<?= $project->projectPrice ?>" id="input" placeholder="0">
                          </div>
                          <div class="form-group col-md-6">
                            <label for="input">Date Created</label>
                            <input required readonly type="text" name="pdate" class="form-control" id="input" value="<?= $project->CreatedAt ?>" placeholder="email">
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" name="pupdate" class="btn btn-primary">Sign in</button>
                      <?php } ?>
