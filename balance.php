      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">Balance Sheets</h3>
          </div>
            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Balance Sheets
                  </li>
                </ol>
              </div>
            </div>
	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<h4 class="card-title">Balance Sheets<a href="addcflow.php" style="background-color: green; color: #ffffff; padding: 7px; border-radius: 5px; margin: 5px;">+ Add Balance Sheet</a></h4>
			...
			<div class="card-content collapse show">
				...
				<div class="table-responsive">
					<table class="table">
						...
						<tbody>
            <?php
            foreach ($balanceSheetEntries as $entry) {
            echo "<tr>";
            echo "<td>{$entry->entry_id}</td>";
            echo "<td>{$entry->account_name}</td>";
            echo "<td>{$entry->account_type}</td>";
            echo "<td>{$entry->amount}</td>";
            echo "<td>{$entry->entry_date}</td>";
            echo "<td>{$entry->currency}</td>";
            echo "<td>{$entry->description}</td>";
            echo "<td>{$entry->created_at}</td>";
            echo "<td>{$entry->updated_at}</td>";
            echo '<td><a href="editbalance.php?balid='.$entry->entry_id.'" style="background-color: green; color: #ffffff; padding: 7px; border-radius: 5px;">Edit</a></td>';
            echo "</tr>";
        }
        ?>
						</tbody>
