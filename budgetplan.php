      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">Budget Plans</h3>
          </div>
            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Budget Plans
                  </li>
                </ol>
              </div>
            </div>
	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<h4 class="card-title">Budget Plans<a href="addcflow.php" style="background-color: green; color: #ffffff; padding: 7px; border-radius: 5px; margin: 5px;">+ Add Budget Plan</a></h4>
			...
			<div class="card-content collapse show">
				...
				<div class="table-responsive">
					<table class="table">
						...
						<tbody>
            <?php
            foreach ($selectedEntriesbud as $entry) {
            echo "<tr>";
            echo "<td>{$entry->budget_id}</td>";
            echo "<td>{$entry->category}</td>";
            echo "<td>{$entry->description}</td>";
            echo "<td>{$entry->amount}</td>";
            echo "<td>{$entry->planned_date}</td>";
            echo "<td>{$entry->actual_date}</td>";
            echo "<td>{$entry->recurring}</td>";
            echo "<td>{$entry->recurring_frequency}</td>";
            ...
            echo "<td>{$entry->updated_at}</td>";
            echo '<td><a href="editbud.php?budid='.$entry->budget_id.'" style="background-color: green; color: #ffffff; padding: 7px; border-radius: 5px;">Edit</a></td>';
