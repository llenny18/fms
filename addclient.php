                    ...
                    <form method="post">
                        ...
                        <div class="form-row">
                          <div class="form-group col-md-6">
                            ...
                            <input required type="text" value="<?php echo(rand(100000009,1000000009)) ?>" readonly name="cid" class="form-control"  id="inputeTextss" placeholder="0">
                          </div>
                          <div class="form-group col-md-6">
                            <label for="inputPassword4">Email</label>
                            <input required type="text" name="cemail" class="form-control" id="inputPassword4"  placeholder="email">
                          </div>
                        </div>
                        <div class="form-group">
                          <label for="inputAddress">Full Name</label>
                          <input required type="text" name="cfname" class="form-control" id="inputAddress"  placeholder="Full Name">
                        </div>
                        <div class="form-group">
                          <label for="inputAddress">Contact Number</label>
                          <input required type="text" name="cnum" class="form-control" id="inputAddress"  placeholder="Full Name">
                        </div>

                        <div class="form-row">
                          <div class="form-group col-md-6">
                            <label for="inputeTextss">Address</label>
                            <input required type="text" name="caddress" class="form-control"  id="inputeTextss" placeholder="0">
                          </div>
                          <div class="form-group col-md-6">
                            <label for="inputPassword4">Age</label>
                            <input required type="text" name="cage" class="form-control" id="inputPassword4"  placeholder="email">
                          </div>
                        </div>
                        <div class="form-group">
