      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" nav-item"><a href="icons.html"><i class="ft-droplet"></i><span class="menu-title" data-i18n="">Costing</span></a>
            ...
            <li class="active" ><a href="tables.html"><i class="ft-credit-card"></i><span class="menu-title" data-i18n="">Financials</span></a>
            </li>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">Financials</h3>
          </div>
            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Financial Statements
                  </li>
                </ol>
              </div>
            </div>
	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<h4 class="card-title">Financial Statements per Month<a href="http://" style="background-color: green; color: #ffffff; padding: 7px; border-radius: 5px; margin: 5px;">View Cash flow</a><a href="http://" style="background-color: green; color: #ffffff; padding: 7px; border-radius: 5px; margin: 5px;">View Income Statement</a><a href="http://" style="background-color: green; color: #ffffff; padding: 7px; border-radius: 5px; margin: 5px;">View Profits and Loss</a></h4>
					...
					<table class="table">
						...
						<tbody>
							<tr>
								<th scope="row">1</th>
								<td>December 2023</td>
								<td><a href="http://" style="background-color: green; color: #ffffff; padding: 7px; border-radius: 5px;">View</a></td>
							</tr>
